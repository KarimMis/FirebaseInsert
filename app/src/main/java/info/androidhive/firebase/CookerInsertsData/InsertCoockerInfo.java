package info.androidhive.firebase.CookerInsertsData;
...
import info.androidhive.firebase.model.Cooker;
           ...
           filepath = mStorage.child(FIREBASE_STORAGE_PATH + System.currentTimeMillis() + "." + getImageExt(imgUri));
            ...
            filepath.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mDatabaseRef.child(uploadId).setValue(cookerInfo);

                    progressDialog.dismiss();

                    Toast.makeText(InsertCoockerInfo.this,"Success",Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(InsertCoockerInfo.this, MainActivity.class);
